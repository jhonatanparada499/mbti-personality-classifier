...
[Working With Text Data](https://scikit-learn.org/1.4/tutorial/text_analytics/working_with_text_data.html) (reading: Evaluation of the performance on the test set) Covers: Bags of words, n-grams CountVectorizer, naïve Bayes classifier(scikit implementation: MultinomialNB)  
|  
